                        ...
                        <?php if ($field->field_type == 'flexible_content'): ?>
                            <tr class="yap-flexible-layouts-row">
                                <td colspan="6" style="background: #f9f9f9; padding: 15px;">
                                    <strong>🎨 Zarządzanie Layoutami:</strong>
                                    ...
                                    <p class="description" style="margin-top: 8px;">
                                        Kliknij przycisk aby dodać różne typy sekcji (layouty) dla tego Flexible Content.<br>
                                        Każdy layout może mieć własny zestaw pól.
                                    </p>
                                </td>
                            </tr>
                        <?php endif; ?>
